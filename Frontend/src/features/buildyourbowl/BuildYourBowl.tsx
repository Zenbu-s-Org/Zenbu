...
function BuildYourBowl() {
    ...
    const toggleIngredient = (ingredient: Ingredient) => {
        setSelected(prev => ({
            ...prev,
            [ingredient.category]:
                prev[ingredient.category] === ingredient._id
                    ? null
                    : ingredient._id
        }));
    };
  ...
  return (
    <section className="w-full px-4 py-20">
        <Container variant="primary" className="flex flex-col items-center relative">
            <span className="absolute top-[-40px] -rotate-6 bg-lime-300 text-lime-900 px-6 py-1 font-['Bricolage_Grotesque'] text-2xl font-bold uppercase border-4 border-lime-900 rounded-3xl">149 sek</span>
            <img src={roundLogo} alt="round-logo" className="my-4"></img>
            <h2 className="font-['Bricolage_Grotesque']">Build Your Own Bowl</h2>
            <h3 className="font-['Nunito'] text-lg mb-6">Click to swap ingredients</h3>
